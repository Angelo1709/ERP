    ...
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-[#14532D] to-[#1D4B35]">
      <div className="w-full max-w-sm mx-4">
        <div className="text-center mb-8">
          ...
          <p className="text-emerald-300 text-sm mt-1">Iniciá sesión para continuar</p>
        </div>
...
export default function App() {
  ...
  // El rol viene del JWT (autenticación real), no del selector de datos
    ...
    <div className="flex h-screen bg-[#F6F8F5] font-sans overflow-hidden">
      <aside className="group/sidebar relative w-[78px] hover:w-[284px] bg-gradient-to-b from-[#14532D] to-[#1D4B35] flex flex-col flex-shrink-0 border-r border-[#1F7A4D]/45 shadow-[0_10px_28px_rgba(20,83,45,0.35)] transition-all duration-300">
        ...
        <div className="px-2 py-3 border-t border-[#2A6A49]/60 space-y-1">
          <div className="flex items-center justify-center group-hover/sidebar:justify-start gap-0 group-hover/sidebar:gap-2 px-2 py-2">
            ...
            <div className="min-w-0 overflow-hidden max-w-0 opacity-0 group-hover/sidebar:max-w-44 group-hover/sidebar:opacity-100 transition-all duration-300 ml-0 group-hover/sidebar:ml-0">
          ...
          <button
            ...
            className="w-full flex items-center justify-center group-hover/sidebar:justify-start gap-0 group-hover/sidebar:gap-2 px-2 group-hover/sidebar:px-3 py-2 rounded-xl text-emerald-400 hover:bg-red-900/40 hover:text-red-300 transition-all"
            title="Cerrar sesión"
          >
            <span className="flex-shrink-0">
            ...
            <span className="min-w-0 overflow-hidden max-w-0 opacity-0 group-hover/sidebar:max-w-44 group-hover/sidebar:opacity-100 transition-all duration-300 whitespace-nowrap text-xs">
              Cerrar sesión
            </span>
          </button>
        </div>
